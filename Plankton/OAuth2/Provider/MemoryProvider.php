...
namespace Plankton\OAuth2\Provider;
...
class MemoryProvider implements AccessTokenProvider{
	...
	/**
	 * {@inheritDoc}
	 * @see \Plankton\OAuth2\Provider\AccessTokenProvider::getAccessToken()
	 */
	...
	/**
	 * {@inheritDoc}
	 * @see \Plankton\OAuth2\Provider\AccessTokenProvider::refreshToken()
	 */
	...
	/**
	 * {@inheritDoc}
	 * @see \Plankton\OAuth2\Provider\AccessTokenProvider::isValidAccessToken()
	 */
